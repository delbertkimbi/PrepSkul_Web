    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-12">
          ...
          {/* Section 7 */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. AI & Interactive Tools (Ticha & SkulMate)</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              We offer specialized AI and interactive tools designed to enhance the educational experience:
            </p>
            <div className="space-y-4">
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                <h3 className="font-semibold text-gray-900 mb-2">Ticha AI</h3>
                <p className="text-gray-700">
                  Ticha is an AI-powered assistant designed to help tutors and teachers in Africa structure their lessons. It converts lesson plans and notes into well-structured PowerPoint presentations to facilitate effective teaching. While we strive for accuracy, Ticha-generated content is automated and may contain errors. You are responsible for reviewing and verifying all presentations before using them in a classroom setting.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                <h3 className="font-semibold text-gray-900 mb-2">SkulMate</h3>
                <p className="text-gray-700">
                  SkulMate is an interactive learning tool that turns student notes into a game. It is intended to make revision engaging and fun. By uploading notes to SkulMate, you grant us permission to process that content to generate quiz questions and game elements. We do not claim ownership of your original notes.
                </p>
              </div>
            </div>
            <p className="text-gray-700 leading-relaxed mt-4">
              Both tools are provided "as is." We do not guarantee that they will be error-free or suitable for every specific educational need.
            </p>
          </section>
