-- Tutor public stats: denormalized counts readable by all users (via tutor_profiles RLS).
-- Combines on-platform + off-platform (offline ops) sessions and students.
